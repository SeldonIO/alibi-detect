...
class OutlierAEGMM(BaseOutlierDetector, FitMixin, ThresholdMixin):
    ...
    def fit(self,
        ...
        w_energy
            Weight on sample energy loss term if default `loss_aegm` loss fn is used.
        w_cov_diag
            Weight on covariance regularizing loss term if default `loss_aegm` loss fn is used.
        optimizer
