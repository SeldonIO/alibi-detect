...
def test_mmd_online_state_functional(tmp_path):
    """
    A functional test of save/load/reset_state methods or MMDDriftOnlineTorch. State is saved, reset, and loaded, with
...
def test_mmd_online_state_unit(tmp_path):
    """
    A unit-type test of save/load/reset_state methods or MMDDriftOnlineTorch. Stateful attributes in STATE_DICT are
