...
class ClassifierDriftTorch(BaseClassifierDrift):
    def __init__(
        ...
        self.predict_fn = partial(predict_batch, device=self.device, preprocess_fn=preprocess_batch_fn,
                                  batch_size=batch_size)
        self.train_kwargs = {'optimizer': optimizer, 'preprocess_fn': preprocess_batch_fn, 'epochs': epochs,
