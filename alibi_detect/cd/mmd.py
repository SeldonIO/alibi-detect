...
class MMDDrift:
    def __new__(cls, *args, **kwargs):
        # Get necessary kwargs
        backend = kwargs.pop('backend', 'tensorflow')
        ...
        # Return backend-specific detector
        if backend == 'tensorflow' and has_tensorflow:
            kwargs.pop('device', None)
            return MMDDriftTF(*args, **kwargs)
        else:
            return MMDDriftTorch(*args, **kwargs)
