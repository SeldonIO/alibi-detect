...
import numpy as np
from typing import Union, Optional, Callable, Dict, List, Tuple, Any, get_args
...
def _prep_model_and_embedding(model: Optional[Callable], emb: Optional[TransformerEmbedding],
                              backend: str) -> Callable:
    """
...
def _load_detector_legacy(filepath: Union[str, os.PathLike], suffix: str, **kwargs) -> Detectors:
    """
