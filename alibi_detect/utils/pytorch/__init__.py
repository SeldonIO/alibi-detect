...
GaussianRBF, DeepKernel = import_optional("alibi_detect.utils.pytorch.kernels", names=["GaussianRBF", "DeepKernel"])

predict_batch, predict_batch_transformer = import_optional(
    "alibi_detect.utils.pytorch.prediction", names=["predict_batch", "predict_batch_transformer"]
)

get_device, quantile, zero_diag = import_optional(
    "alibi_detect.utils.pytorch.misc", names=["get_device", "quantile", "zero_diag"]
)
