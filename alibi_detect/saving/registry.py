...
if has_tensorflow:
    ...
    from alibi_detect.utils.tensorflow.kernels import sigma_median as sigma_median_tf
...
if has_pytorch:
    ...
    from alibi_detect.utils.pytorch.kernels import sigma_median as sigma_median_torch

if has_keops:
    from alibi_detect.utils.keops.kernels import GaussianRBF as GaussianRBF_keops
