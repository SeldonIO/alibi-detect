"""Pydantic models used by :func:`~alibi_detect.utils.validate.validate_config` to validate configuration
dictionaries.
...
from alibi_detect.saving.validators import NDArray, coerce_2_tensor, coerce_int2list, validate_framework
from alibi_detect.utils._types import (Literal, supported_models_all, supported_models_sklearn, supported_models_tf,
                                       supported_models_torch, supported_optimizers_all, supported_optimizers_tf,
...
class OptimizerConfig(CustomBaseModelWithKwargs):
    """Unresolved schema for optimizers.

    The `optimizer` dictionary has two possible formats:
