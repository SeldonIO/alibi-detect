...
TransformerEmbedding = import_optional("alibi_detect.models.tensorflow.embedding", names=["TransformerEmbedding"])

PixelCNN = import_optional("alibi_detect.models.tensorflow.pixelcnn", names=["PixelCNN"])

resnet, scale_by_instance = import_optional(
    "alibi_detect.models.tensorflow.resnet", names=["resnet", "scale_by_instance"]
)

trainer = import_optional("alibi_detect.models.tensorflow.trainer", names=["trainer"])
