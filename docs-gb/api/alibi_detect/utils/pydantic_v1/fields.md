...
### `Undefined`
```python
Undefined: pydantic.v1.fields.UndefinedType = PydanticUndefined
```
...
### `SHAPE_NAME_LOOKUP`
```python
SHAPE_NAME_LOOKUP: dict = {2: 'List[{}]', 3: 'Set[{}]', 6: 'Tuple[{}, ...]', 7: 'Sequence[{}]', 8: 'Fro...
```

### `MAPPING_LIKE_SHAPES`
```python
MAPPING_LIKE_SHAPES: set = {4, 12, 13, 14}
```
