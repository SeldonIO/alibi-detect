...
| `reg_loss_fn` | `Callable` | `<function LearnedKernelDrift.<lambda> at 0x28fe7ea60>` | The regularisation term reg_loss_fn(kernel) is added to the loss function being optimized. |
