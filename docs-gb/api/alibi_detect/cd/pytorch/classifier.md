...
| `reg_loss_fn` | `Callable` | `<function ClassifierDriftTorch.<lambda> at 0x2922edc10>` | The regularisation term reg_loss_fn(model) is added to the loss function being optimized. |
