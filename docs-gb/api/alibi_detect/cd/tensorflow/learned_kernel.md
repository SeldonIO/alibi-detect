...
| `reg_loss_fn` | `Callable` | `<function LearnedKernelDriftTF.<lambda> at 0x2922f7040>` | The regularisation term reg_loss_fn(kernel) is added to the loss function being optimized. |
...
| `epochs` | `int` | `20` |  |
| `reg_loss_fn` | `Callable` | `<function LearnedKernelDriftTF.<lambda> at 0x2922f73a0>` |  |
| `verbose` | `int` | `1` |  |
