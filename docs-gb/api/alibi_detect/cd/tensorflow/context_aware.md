...
### `logger`
```python
logger: logging.Logger = <Logger alibi_detect.cd.tensorflow.context_aware (WARNING)>
```
...
| `x_kernel` | `Callable` | `<class 'alibi_detect.utils.tensorflow.kernels.GaussianRBF'>` | Kernel defined on the input data, defaults to Gaussian RBF kernel. |
| `c_kernel` | `Callable` | `<class 'alibi_detect.utils.tensorflow.kernels.GaussianRBF'>` | Kernel defined on the context data, defaults to Gaussian RBF kernel. |
