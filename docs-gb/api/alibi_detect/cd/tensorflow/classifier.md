...
| `reg_loss_fn` | `Callable` | `<function ClassifierDriftTF.<lambda> at 0x2922ba3a0>` | The regularisation term reg_loss_fn(model) is added to the loss function being optimized. |
